...
//  Copyright © 2016 thehut. All rights reserved.
//
...
public class SwipeToFlipButton: UIView {
    ...
    */
    ...
    public init(frame: CGRect, sequenceArray: NSArray, defaultArrayItem: Int) {
        ...
        backView.textAlignment = alignment
        backView.font = buttonFont
        frontView = UILabel(frame: CGRect(origin: CGPoint(x: 0,y: 0), size: frame.size))
        frontView.backgroundColor = UIColor.whiteColor()
        frontView.text = "\(seqArray[currentItem])"
        frontView.textAlignment = alignment
        frontView.font = buttonFont
    ...
    func flipView(direction: UIViewAnimationOptions, textString: String) {
        UIView.transitionFromView(backShowing ? backView : frontView, toView: backShowing ? frontView : backView, duration: animateDuration, options: direction, completion: nil)
        if backShowing { frontView.text = textString } else { backView.text = textString }
        backShowing = !backShowing
    }
    
//    func flipLeft() {
//        if backShowing {
//            UIView.transitionFromView(backView, toView: frontView, duration: 0.375, options: UIViewAnimationOptions.TransitionFlipFromLeft, completion: nil)
//        } else {
//            UIView.transitionFromView(frontView, toView: backView, duration: 0.375, options: UIViewAnimationOptions.TransitionFlipFromLeft, completion: nil)
//        }
//        backShowing = !backShowing
//    }
//    
...
//        
//        if backShowing {
//            UIView.transitionFromView(backView, toView: frontView, duration: 0.375, options: UIViewAnimationOptions.TransitionFlipFromRight, completion: nil)
//        } else {
//            UIView.transitionFromView(frontView, toView: backView, duration: 0.375, options: UIViewAnimationOptions.TransitionFlipFromRight, completion: nil)
//        }
//        backShowing = !backShowing
//    }
